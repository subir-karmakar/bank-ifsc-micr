            ...
            <div class="text-center" style="background-color: #ffffff;height: 95%;">
                ...
                ?>
                    ...
                    <select id="sel_state" name="state"
                        class="form-control form-control-sm mx-auto" style="max-width: 335px;margin-bottom: 5px;" required="">
                        <option value="" selected="" disabled>~ Select State ~</option>
                       
                        </select>
                        <select id="sel_dist" name="dist"
                        class="form-control form-control-sm mx-auto" style="max-width: 335px;margin-bottom: 5px;" required="">
                        <option value="" selected="" disabled>~ Select District ~</option>
                        </select>
                        <select id="sel_branch" name="branch"
                            class="form-control form-control-sm mx-auto" style="max-width: 335px;margin-bottom: 10px;" required="">
